...
return [
    ...
    // --- Koneksi database web (untuk prospek & dashboard admin) ---
    'web' => [
        'host'    => '127.0.0.1',
        'port'    => 3306,
        'dbname'  => 'web_kwgr',
        'user'    => 'web_admin',
        'pass'    => 'GANTI_DENGAN_PASSWORD_KUAT',
        // Password dashboard admin (/admin/) — hash bcrypt. Buat dengan:
        //   php -r "echo password_hash('password-anda', PASSWORD_DEFAULT);"
        'admin_pass' => 'GANTI_DENGAN_HASH_BCRYPT',
    ],

    // --- Koneksi ERP (read-only, utk resolve nama motor) ---
    'erp' => [
        'host'    => '127.0.0.1',
        'port'    => 3306,
        'dbname'  => 'greentech_prod',
